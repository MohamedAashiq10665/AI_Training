...
class CustomerBusinessProfileCreate(BaseModel):
    ...
    def validate_date_order(self):
        if self.onboarding_date <= self.establishment_start_date:
            raise ValueError("onboarding_date must be greater than establishment_start_date")
        return self
...
class CustomerBusinessProfileUpdate(BaseModel):
    ...
    establishment_start_date: date | None = None
