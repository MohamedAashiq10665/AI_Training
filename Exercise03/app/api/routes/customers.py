...
from app.models.schemas import (
    ...
    EnrichedCustomerProfileResponse,
    CustomerResponse,
    CustomerUpdate,
    TagResponse,
)
...
def _raise_http_error(error: Exception) -> None:
    ...
    if isinstance(error, ExternalAuthError):
...
@router.get("/{customer_id}/enriched-profile", response_model=EnrichedCustomerProfileResponse)
def get_enriched_customer_profile(
    ...
    try:
        return service.get_enriched_customer_profile(
            customer_id,
            include_activity=include_activity,
            include_weather=include_weather,
        )
    except (NotFoundError, ExternalAuthError, ExternalRateLimitError, ExternalServiceError) as error:
        _raise_http_error(error)
