...
- Candidate ranking remains deterministic (RAG retrieval + weighted scoring).
- `recommendation_reason` is generated by the configured Ollama model.
- If LLM generation fails, a deterministic fallback reason is returned.
